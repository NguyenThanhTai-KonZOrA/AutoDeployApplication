...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClientLauncher.Implement.EntityModels.ApplicationSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "System",
                            DataType = "Boolean",
                            Description = "On / Off Check Administrator Role",
                            IsActive = true,
                            IsDelete = false,
                            Key = "EnableCheckAdministrator",
            ...
            modelBuilder.Entity("ClientLauncher.Implement.EntityModels.ClientMachine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<long?>("AvailableDiskSpaceGB")
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("InstalledApplications")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ClientLauncher.Implement.EntityModels.DeploymentTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DeploymentHistoryId")
                        .HasColumnType("int");

                    b.Property<string>("DeploymentNotes")
                        .HasColumnType("nvarchar(max)");

                    b.Property<long?>("DownloadSizeBytes")
                        .HasColumnType("bigint");
                    ...
                    b.Property<TimeSpan?>("InstallDuration")
                        .HasColumnType("time");
                    ...
                    b.Property<int>("TargetMachineId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DeploymentHistoryId");
                    ...
                    b.HasIndex("TargetMachineId", "Status");
            ...
            modelBuilder.Entity("ClientLauncher.Implement.EntityModels.DeploymentTask", b =>
                {
                    b.HasOne("ClientLauncher.Implement.EntityModels.DeploymentHistory", "DeploymentHistory")
                        .WithMany()
                        .HasForeignKey("DeploymentHistoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("ClientLauncher.Implement.EntityModels.ClientMachine", "TargetMachine")
                        .WithMany("DeploymentTasks")
                        .HasForeignKey("TargetMachineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DeploymentHistory");

                    b.Navigation("PackageVersion");

                    b.Navigation("TargetMachine");
                });
