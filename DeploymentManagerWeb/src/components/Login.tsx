        ...
        if (token && !loading) {
            ...
            if (from && from !== '/login') {
                ...
                if (roles.includes(UserRole.ADMIN)) {
                    ...
                    //console.log('✅ [Redirect] Redirecting to /admin-dashboard (Viewer)');
                    navigate('/admin-dashboard', { replace: true });
                } else {
